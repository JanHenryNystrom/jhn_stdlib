%%==============================================================================
%% Copyright 2015-2026 Jan Henry Nystrom <JanHenryNystrom@gmail.com>
%%
...
%% @copyright (C) 2015-2026, Jan Henry Nystrom <JanHenryNystrom@gmail.com>
%%%-------------------------------------------------------------------
-module(jhn_shttpc).
...
uri(IoData) -> uri(jhn_uri:decode(IoData)).
